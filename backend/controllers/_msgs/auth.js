...
const msg = (typeAndMsgName, customized = "NeedCustomWord", options) => {
    ...
    error.sessionEnded = "A sua sessão terminou.";
    error.notAuthorized =
        "Você não tem autorização para acessar este documento";
    error.accessDenied = "Acesso Negado. Somente admin";
    error.expiredAuthToken = "O prazo para trocar a senha expirou.";
    error.noAuthToken =
        "Não foi encontrado nenhuma solicitação de mudança de senha";
    ...
    error.noReCaptchaToken =
        "Último passo. Clique na caixa do Google ReCaptcha";
    ...
    error.invalidCredentials =
        "Credenciais Inválidas. Se for o caso, tente colocar em minúsculas";
    error.invalidPhone =
        "Formato telefone inválido. Digita de 10 a 11 dígitos com DDD. ex: 95977779999";
    error.invalidCpf = "O CPF informado não é válido.";
    error.userAlreadyRegistered = "Nome inválido. Tente novamente.";
    error.emailAlreadyRegistered =
        "Erro ao cadastrar. Verifique NOME ou EMAIL e tente novamente.";
    error.cpfAlreadyRegistered =
        "Erro ao cadastrar. Verifique NOME ou CPF e tente novamente."; // Security Vulnability - do not narrow down about each issue was rejected: Esse CPF já foi registrado. Tente um outro.
    // END MESSAGES
