...
const msg = (typeAndMsgName, customized = "NeedCustomWord", options) => {
    ...
    // MESSAGES
    (ok.sentNewPassLinkEmail =
        "Um email foi enviado com instruções pra recuperar seu acesso"),
        (ok.successBuyRequest =
            "Pedido registrado e enviado com sucesso! Acompanhe o andamento pela sua conta de acesso!");
    ...
    ok.resend =
        "Email de Confirmação Reenviado, verifique também sua caixa de spam";
    error.notSent = `Email not sent! Details: ${customized} End. || Trying with another provider...`;
    error.notRegistered =
        "Esse email não foi registrado. Verique se digitou corretamente.";
